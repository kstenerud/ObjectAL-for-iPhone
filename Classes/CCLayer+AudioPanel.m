...
{
	CGSize screenSize = [[CCDirector sharedDirector] winSize];
	CCLabel* label = [CCLabel labelWithString:title fontName:@"Helvetica-Bold" fontSize:24];
...
{
	CGSize screenSize = [[CCDirector sharedDirector] winSize];
	CCSprite* label = [CCLabel labelWithString:str fontName:@"Helvetica" fontSize:20];
