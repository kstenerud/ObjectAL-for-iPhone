...
@property(nonatomic, readwrite, assign) CFIndex lastRandomIndex;
...
- (void) switchSegment
{
    ...
    NSString* name = [[self.buffers allKeys] objectAtIndex:[self randomIndex]];
